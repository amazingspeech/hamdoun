...
Herbruikbaar per release naar `kwantiq.tessar.nl`. Loop 'm van boven
...
- [ ] Smoke test op productie: `curl https://kwantiq.tessar.nl/health`
...
- [ ] Certo (`vandijkprotocol.tessar.nl`) en n8n (`n8n.tessar.nl`) op
      ...
      gedeelde server.
- [ ] Caddy-logs (`/var/log/caddy/kwantiq.log`) een paar minuten
