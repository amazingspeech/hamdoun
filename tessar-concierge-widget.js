...
(function () {
  ...
  var css = ""
    ...
    + "background:oklch(34% 0.05 175);"
    + "box-shadow:0 10px 30px -8px oklch(18% 0.02 70 / 0.45);display:flex;align-items:center;justify-content:center;"
    + "transition:transform 180ms ease, box-shadow 180ms ease;}"
    + ".tsc-launcher:hover{transform:translateY(-2px) scale(1.03);box-shadow:0 14px 34px -8px oklch(18% 0.02 70 / 0.55);}"
    + ".tsc-launcher svg{width:26px;height:26px;fill:#fff;}"
    + ".tsc-bubble-hint{position:absolute;bottom:70px;right:0;max-width:230px;background:oklch(18% 0.02 70);color:#fff;"
    ...
    + "border:1px solid oklch(90% 0.01 70);}"
    + ".tsc-panel.tsc-open{display:flex;}"
    + ".tsc-header{padding:18px 18px 16px;background:oklch(18% 0.02 70);color:#fff;display:flex;align-items:center;gap:12px;flex:none;cursor:grab;touch-action:none;user-select:none;}"
    + ".tsc-header.tsc-dragging{cursor:grabbing;}"
    + ".tsc-header-avatar{position:relative;width:36px;height:36px;flex:none;}"
    + ".tsc-header-avatar-circle{width:36px;height:36px;border-radius:50%;background:oklch(34% 0.05 175);"
    ...
    + ".tsc-header-dot{position:absolute;right:-1px;bottom:-1px;width:10px;height:10px;border-radius:50%;background:oklch(70% 0.18 150);border:2px solid oklch(18% 0.02 70);flex:none;}"
    + ".tsc-header-text{flex:1;min-width:0;}"
    + ".tsc-header-title{font-weight:700;font-size:0.9375rem;letter-spacing:-0.01em;}"
    + ".tsc-header-sub{font-size:0.75rem;color:oklch(78% 0.06 70);margin-top:1px;}"
    ...
    + ".tsc-body{flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:10px;background:oklch(98% 0.005 70);}"
    ...
    + ".tsc-msg-bot{align-self:flex-start;background:#fff;border:1px solid oklch(92% 0.008 70);color:oklch(20% 0.02 70);border-bottom-left-radius:4px;}"
    ...
    + ".tsc-msg-user{align-self:flex-end;background:oklch(18% 0.02 70);color:#fff;border-bottom-right-radius:4px;}"
    + ".tsc-starters{display:flex;flex-direction:column;gap:8px;padding:0 16px 12px;flex:none;}"
    + ".tsc-starter-btn{text-align:left;background:oklch(96% 0.015 175);border:1px solid oklch(88% 0.03 175);color:oklch(30% 0.05 70);"
    ...
    + ".tsc-starter-btn:hover{background:oklch(92% 0.03 175);}"
    + ".tsc-inputrow{display:flex;gap:8px;padding:12px;border-top:1px solid oklch(92% 0.008 70);flex:none;background:#fff;}"
    + ".tsc-input{flex:1;border:1px solid oklch(88% 0.01 70);border-radius:10px;padding:10px 12px;font-size:0.875rem;font-family:inherit;resize:none;outline:none;}"
    + ".tsc-input:focus{border-color:oklch(34% 0.05 175);}"
    + ".tsc-send{background:oklch(18% 0.02 70);border:none;color:#fff;width:40px;border-radius:10px;cursor:pointer;flex:none;display:flex;align-items:center;justify-content:center;}"
    + ".tsc-send:disabled{opacity:0.5;cursor:default;}"
    + ".tsc-typing{align-self:flex-start;display:flex;gap:4px;padding:10px 13px;}"
    + ".tsc-typing span{width:6px;height:6px;border-radius:50%;background:oklch(70% 0.02 70);animation:tsc-bounce 1.2s infinite ease-in-out;}"
