...
(function () {
  ...
  var css = ""
    ...
    + ".tsc-header-avatar-circle{width:36px;height:36px;border-radius:50%;background:oklch(43% 0.07 188);"
    ...
    + ".tsc-input:focus{border-color:oklch(43% 0.07 188);}"
